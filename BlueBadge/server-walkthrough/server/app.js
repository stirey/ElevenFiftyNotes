...
//this const can be name anything, but what matters is we are requiring the right file
const usercontroller = require('./controllers/usercontroller');
app.use('/user', usercontroller) //we are saying use this controller at the endpoint /user
